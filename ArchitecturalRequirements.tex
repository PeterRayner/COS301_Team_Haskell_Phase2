...
\begin{document}
	...
	\section{Overall System Design}
	   ...
	   \subsection{Deployment}
	        \begin{figure}[H]
            \centering	            \centerline{\fbox{\includegraphics[scale=0.3]{Deployment-Diagram.png}}}
	...
	\section{Users}
		...
		\begin{figure}[H]
            \centering	            \centerline{\fbox{\includegraphics[scale=0.4]{Users Use Case Diagram}}}
            \caption{Use Case Diagram - Users Module}
        \end{figure}
    ...
    \section{Data}
        ...
        \begin{figure}[H]
            \centering	            
            \centerline{\fbox{\includegraphics[scale=0.4]{Database-Diagram-Data.png}}}
            \caption{Database Diagram - Data Module}
        \end{figure} 
        
        \begin{figure}[H]
            \centering	            
            \centerline{\fbox{\includegraphics[scale=0.5]{Sequence-Diagram-Data.png}}}
            \caption{Sequence Diagram - Data Module}
        \end{figure} 
        
        \begin{figure}[H]
            \centering	            
            \centerline{\fbox{\includegraphics[scale=0.37]{Storage-Diagram-Data.png}}}
    ...
    \section{Surveillance}    
        ...
        \begin{figure}[H]
            \centering	            
            \centerline{\fbox{\includegraphics[scale=0.4]{Activity-Diagram-Surveillance}}}
